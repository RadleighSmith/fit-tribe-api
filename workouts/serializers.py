...
class WorkoutSerializer(serializers.ModelSerializer):
    ...
    Workout objects, including additional computed fields for ownership,
    profile information, like status, and associated workout items.
    """
    ...
    def validate_banner(self, value):
        """
        Validate the banner image to ensure it meets size and dimension
        constraints.
        """
    ...
    def validate_image(self, value):
        """
        Validate the content image to ensure it meets size and dimension
        constraints.
        """
        max_size = 1024 * 1024 * 2  # 2 MB
        max_width = 4096
    ...
    class Meta:
        ...
        fields = [
            ...
            'workout_comments_count', 'workout_items'
        ]
