...
class Blog(models.Model):
    ...
    Attributes:
        owner (ForeignKey): The user who owns the blog post. ForeignKey links to User model.
        ...
        image (ImageField): Optional content image, with a default set so we can always reference an image url.
